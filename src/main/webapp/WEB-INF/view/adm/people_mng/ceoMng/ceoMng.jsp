...
<<<<<<< .mine
		$("#comp_addr").val(object.comp_addr);
=======
...
<body>
	<form id="myForm" action="" method="">
		<input type="hidden" id="currentPage" value="1"> <input
			type="hidden" id="tmp_type" name="user_type" value="E"> <input type="hidden"
						...
						<div class="content">
							...
							<p class="Location">
								<a href="/notice/aNotice.do" class="btn_set home">메인으로</a> <a href=""
									class="btn_nav">인원 관리</a> <span class="btn_nav bold">대표
					...
					<table class="row">
						...
						<tbody>
							...
							<th scope="row">회사 주소</th>
								<td><input type="text" class="inputTxt p100" id="comp_addr"
									name="comp_addr" /></td>
							<th scope="row">회사 이메일</th>
								<td><input type="text" class="inputTxt p100" id="comp_mail"
									name="comp_mail" /></td>		
							</tr>
						</tbody>
					</table>
