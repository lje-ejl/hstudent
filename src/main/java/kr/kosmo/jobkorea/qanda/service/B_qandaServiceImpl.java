...
import kr.kosmo.jobkorea.qanda.dao.B_qandaDao;
...
@Service
public class B_qandaServiceImpl implements B_qandaService {
	...
	// qna 목록 카운트
	@Override
	public Integer countListComnGrpCod(Map<String, Object> paramMap) throws Exception {
